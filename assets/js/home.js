jQuery(document).ready(function ($) {
    ...
    function checkContinueUnit() {
        ...
        if (window.location.pathname.indexOf('/en') != -1) {
            var urlUnit = '../../en/' + unitState;
            $('.btn-unit').attr('href', urlUnit);
        } else if (window.location.pathname.indexOf('/es') != -1) {
            var urlUnit = '../../es/' + unitState;
            $('.btn-unit').attr('href', urlUnit);
        }
        ...
        if(sessionStorage.getItem('unitState')){
            ...
            if( $('.accordion__list-item .btn').length !==  $('.accordion__list-item.active .btn').length) {
                ...
                // production
                if (window.location.pathname.indexOf('/en') != -1) {
                    var btnHrefPosition = btnHref.replace('../../en/', '');
                    var btnHrefClean = btnHrefPosition;
                    var urlUnit = '../../en/' + btnHrefClean;
                    $('.btn-unit').attr('href', urlUnit);
                } else if (window.location.pathname.indexOf('/es') != -1) {
                    var btnHrefPosition = btnHref.replace('../../es/', '');
                    var btnHrefClean = btnHrefPosition;
                    var urlUnit = '../../es/' + btnHrefClean;
                    $('.btn-unit').attr('href', urlUnit);
                }
            } 
